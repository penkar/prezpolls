...
export const trumpParty = [
  { start: new Date(`2021 Jan 4`), rep: 82, ind: 30, dem: 4 },
  { start: new Date(`2020 Dec 1`), rep: 87, ind: 34, dem: 6 },
  { start: new Date(`2020 Nov 5`), rep: 90, ind: 39, dem: 3 },
  { start: new Date(`2020 Oct 16`), rep: 95, ind: 41, dem: 3 },
  { start: new Date(`2020 Sep 30`), rep: 94, ind: 35, dem: 4 },
  { start: new Date(`2020 Sep 14`), rep: 94, ind: 39, dem: 7 },
  { start: new Date(`2020 Aug 31`), rep: 92, ind: 36, dem: 4 },
  { start: new Date(`2020 Jul 30`), rep: 90, ind: 39, dem: 5 },
  { start: new Date(`2020 Jul 1`), rep: 91, ind: 34, dem: 4 },
  { start: new Date(`2020 Jun 8`), rep: 91, ind: 33, dem: 2 },
  { start: new Date(`2020 May 28`), rep: 85, ind: 39, dem: 5 },
  { start: new Date(`2020 May 1`), rep: 92, ind: 46, dem: 14 },
  { start: new Date(`2020 Apr 14`), rep: 93, ind: 47, dem: 8 },
  { start: new Date(`2020 Apr 1`), rep: 93, ind: 39, dem: 7 },
  { start: new Date(`2020 Mar 13`), rep: 92, ind: 43, dem: 13 },
  { start: new Date(`2020 Mar 2`), rep: 91, ind: 35, dem: 7 },
  { start: new Date(`2020 Feb 17`), rep: 92, ind: 42, dem: 8 },
  { start: new Date(`2020 Feb 3`), rep: 93, ind: 43, dem: 6 },
  { start: new Date(`2020 Jan 16`), rep: 94, ind: 42, dem: 7 },
  { start: new Date(`2020 Jan 2`), rep: 88, ind: 37, dem: 10 },
  { start: new Date(`2019 Dec 2`), rep: 89, ind: 42, dem: 8 },
  { start: new Date(`2019 Nov 1`), rep: 90, ind: 38, dem: 4 },
  { start: new Date(`2019 Oct 14`), rep: 89, ind: 34, dem: 7 },
  { start: new Date(`2019 Oct 1`), rep: 87, ind: 34, dem: 5 },
  { start: new Date(`2019 Sep 16`), rep: 87, ind: 36, dem: 5 },
  { start: new Date(`2019 Sep 3`), rep: 91, ind: 38, dem: 5 },
  { start: new Date(`2019 Aug 15`), rep: 88, ind: 34, dem: 3 },
  { start: new Date(`2019 Aug 1`), rep: 88, ind: 37, dem: 4 },
  { start: new Date(`2019 Jul 15`), rep: 88, ind: 38, dem: 7 },
  { start: new Date(`2019 Jul 1`), rep: 90, ind: 38, dem: 6 },
  { start: new Date(`2019 Jun 19`), rep: 90, ind: 34, dem: 5 },
  { start: new Date(`2019 Jun 3`), rep: 89, ind: 37, dem: 6 },
...
export const trumpPartyData = {
  president: `Donald J. Trump`,
  party: `republican`,
  chart: Object.assign({}, approvalChartDefault, {
    title: { text: `Presidential Approval Poll by party for Donald Trump` },
  }),
};
